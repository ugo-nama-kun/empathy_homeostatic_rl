...
def make_env(env_id, idx, capture_video, run_name, cognitive_empathy, weight_empathy, fsr):
    def thunk():
...
if __name__ == "__main__":
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env(args.env_id, i, args.capture_video, run_name, args.cognitive_empathy, args.weight_empathy, args.FSR) for i in range(args.num_envs)],
    )
    test_envs = gym.vector.SyncVectorEnv(
        [make_env(args.env_id, i, args.capture_video, run_name, args.cognitive_empathy, args.weight_empathy, args.FSR) for i in range(args.num_test_envs)],
    )
